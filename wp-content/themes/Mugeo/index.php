<?php get_header(); ?>
    ...
    <main class="main">
        <div class="content_grid">
            ...
            <article>
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/src/imgs/postexample4.png"
                    alt="Exemplo de post">
            ...
            <img id="line_with_opacity"
                src="<?php echo get_stylesheet_directory_uri(); ?>/src/imgs/line_with_opacity.png" alt="Linha">

            <article>
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/src/imgs/postexample5.png"
                    alt="Exemplo de post">
                <h4>Pertubações geológicas no ecossistema amazonico</h4>
                <label>Evento</label>
                <p class="article-content">
